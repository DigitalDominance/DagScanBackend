 ...
 */
const dagscanPoolLatestSchema = new mongoose_1.default.Schema({
    ...
    token0Volume: { type: mongoose_1.default.Schema.Types.Mixed, required: true },
    token1Volume: { type: mongoose_1.default.Schema.Types.Mixed, required: true },
    tvl: { type: Number, required: true },
    volumeUSD: { type: Number, required: true },
    token0Fees: { type: mongoose_1.default.Schema.Types.Mixed, required: true },
    token1Fees: { type: mongoose_1.default.Schema.Types.Mixed, required: true },
    feesUSD: { type: Number, required: true },
    token0Reserves: { type: mongoose_1.default.Schema.Types.Mixed, required: true },
    token1Reserves: { type: mongoose_1.default.Schema.Types.Mixed, required: true },
...
exports.default = mongoose_1.default.model('DagscanPoolLatest', dagscanPoolLatestSchema);
