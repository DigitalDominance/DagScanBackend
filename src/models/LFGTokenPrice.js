...
const LFGTokenPriceSchema = new mongoose_1.default.Schema({
...
}, { timestamps: true, autoIndex: true, collection: 'lfg_token_prices' });
LFGTokenPriceSchema.index({ tokenAddress: 1, snappedAt: 1 }, { unique: true });
exports.default = mongoose_1.default.models.LFGTokenPrice || mongoose_1.default.model('LFGTokenPrice', LFGTokenPriceSchema);
